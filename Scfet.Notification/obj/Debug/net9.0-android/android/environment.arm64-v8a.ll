...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 358, ; uint32_t number_of_assemblies_in_apk
...
@bundled_assemblies = dso_local local_unnamed_addr global [358 x %struct.XamarinAndroidBundledAssembly] [
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.scfet.notifications\00", align 1
...
@.DSOCacheEntry.10_name = private unnamed_addr constant [20 x i8] c"libHarfBuzzSharp.so\00", align 1
@.DSOCacheEntry.11_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 1
