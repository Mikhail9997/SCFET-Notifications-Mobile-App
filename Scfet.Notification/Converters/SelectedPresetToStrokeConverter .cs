...
{
    public class SelectedPresetToStrokeConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                if (selectedPreset != null && currentPreset != null &&
                    selectedPreset.Key == currentPreset.Key)
                {
                    return Application.Current.Resources["PrimaryColor"] ?? Colors.Green;
                }
