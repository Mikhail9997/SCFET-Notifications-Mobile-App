...
public partial class ChannelInvitationsPage : ContentPage
{
    private const double ScrollThreshold = 500;

    public ChannelInvitationsPage(ChannelInvitationsViewModel viewModel)
    {
        InitializeComponent();
    ...
    protected override async void OnAppearing()
    {
        ...
        if (BindingContext is ChannelInvitationsViewModel viewModel)
        {
