...
public partial class ChannelMembersPage : ContentPage
{
    private const double ScrollThreshold = 500;

    public string ChannelId { get; set; } = string.Empty;

    public ChannelMembersPage(ChannelMembersViewModel viewModel)
    {
        InitializeComponent();
    ...
    protected override async void OnAppearing()
    {
        ...
        if (BindingContext is ChannelMembersViewModel viewModel)
        {
